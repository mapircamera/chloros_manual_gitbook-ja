...
{% hint style="success" %}
スーパーズーム: マップタイルプロバイダーの最大ズームレベルに達すると、さらにズームするとタイルが拡大され、密集したマークを確認できます。
{% endhint %}
