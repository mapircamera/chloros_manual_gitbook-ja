...
{% hint style="info" %}
**対応ファイル形式**: Chlorosは、MAPIR、Survey3W、Survey3NカメラからのRAW+JPGおよびJPG画像ファイルをサポートします。推奨されるのはRAW+JPGのみです。
{% endhint %}
...
3. 削除を確認します（ファイルはディスクから削除されず、プロジェクトからのみ削除されます）
...
**例**: Survey3W RGN + Survey3N OCN デュアルカメラ構成***
