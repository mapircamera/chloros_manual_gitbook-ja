...
2. **「選択した画像を削除」**ボタンをクリック <img src="../.gitbook/assets/image (2).png" alt="" data-size="line"> ボタンをクリックします
...
* **カメラモデルフィルター**: 複数カメラ使用時にカメラタイプで画像をグループ化***
...
* **前の画像**：左矢印をクリック、または←キーを押す
* **次の画像**：右矢印をクリック、または→キーを押す
...
3. **対象画像の選択** - [対象画像の選択](choosing-target-images.md) を参照
