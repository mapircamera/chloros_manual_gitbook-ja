...
{% ヒント style=&quot;info&quot; %}
**対応ファイル形式**: Chloros は、MAPIR Survey3W および Survey3N カメラからの RAW+JPG および JPG 画像ファイルをサポートします。RAW+JPG のみが推奨されます。
{% endhint %}
...
ファイルブラウザ内の任意の画像サムネイルをクリックすると、メインプレビューエリアに表示されます:
