...
* ✅ **出力ファイル**：処理済み画像がすべてカメラモデルサブフォルダに保存
...
1. カメラモデルサブフォルダに移動
2. 画像ファイルを選択
3. Windows エクスプローラーのプレビューペインに表示
4. 矢印キーで画像を切り替え
...
1. プロジェクト設定でヴィネット補正が有効化されていることを確認
...
6. ✅ **進捗の監視** - [処理の監視](monitoring-the-processing.md) を参照 [処理の監視](monitoring-the-processing.md)
7. ✅ **結果の確認** - このページ

**反射率補正済みのマルチスペクトル画像が分析準備完了です！**
